		...
		<div>
			{allRecs.length > 0 && (
				<div>
                    ...
                    <ul>
                        {allRecs.slice(startRec, endRec).map((rec) => (
                        <div className="recipe-column">
                            <div className="recipe-row">
                                <div className="recipe-card">
                                    <h6><b>{rec.get("name")}{" "}</b></h6>
									{rec.get("ImageURL") && (
                                		<img src={rec.get("ImageURL")} height="200px" width="250px"></img>
                            		)}
                                    <br />
									<br />
                                    ...
                                    <br />
                                    <button onClick={()=>addNewRecipe(rec, cookbooks)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
